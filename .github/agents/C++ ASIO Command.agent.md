---
description: 'C++ experienced ASIO coder.'
...
Your task is to improve command.hpp and command_test.cpp to implement a full transaction enabled persistent command pattern.
Each command must comply with ACID requirements for transactions.
